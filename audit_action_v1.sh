...
/usr/bin/curl  --noproxy '*' -k -u jay.kumar:India@123 "https://br1paprhdd11.passporthealth.com:7187/api/v9/audits/?query=command%3D%3DGRANT_PRIVILEGE&startTime=
...
/usr/bin/curl --noproxy '*' -k -u jay.kumar:India@123 "https://br1paprhdd11.passporthealth.com:7187/api/v9/audits/?query=command%3D%3DREVOKE_PRIVILEGE&startTime=
...
/usr/bin/curl --noproxy '*' -k -u jay.kumar:India@123 "https://br1paprhdd11.passporthealth.com:7187/api/v9/audits/?query=command%3D%3DUSER_LOGIN&startTime=$previ
...
/usr/bin/curl --noproxy '*' -k -u jay.kumar:India@123 "https://br1paprhdd11.passporthealth.com:7187/api/v9/audits/?query=command%3D%3Dmkdirs&startTime=$previous_
